...
import htm from 'htm';
import { getSkills, createSkill } from '../services/api.js';
import { SkillCard } from '../components/SkillCard.js';
import { IconTrophy, IconPlus } from '../components/Icons.js';
import { Modal } from '../components/Modal.js';

const html = htm.bind(React.createElement);

export const Dashboard = ({ onSkillClick }) => {
        ...
        <form onSubmit=${handleCreateSkill} className="space-y-4">
          ...
          <div>
            ...
            <input 
              ...
              maxLength="4"
              value=${newIcon}
              onInput=${(e) => setNewIcon(e.target.value)}
              className="w-full rounded-lg border-gray-600 bg-gray-700 text-white placeholder-gray-400 border p-2.5 focus:ring-2 focus:ring-brand-500 focus:outline-none"
              placeholder="e.g. 🎸"
            />
          ...
          <div>
            ...
            <input 
              ...
              min="0"
              value=${newPoints}
              onInput=${(e) => setNewPoints(Number(e.target.value))}
              className="w-full rounded-lg border-gray-600 bg-gray-700 text-white placeholder-gray-400 border p-2.5 focus:ring-2 focus:ring-brand-500 focus:outline-none"
            />
